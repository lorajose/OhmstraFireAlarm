...
$template = Firefront_Wp_Elements::$template;
...
if( $sidebar_layout != 'no-sidebar' ):
	...
	if( $sidebar_layout == 'left-sidebar' ){
		Firefront_Wp_Elements::firefront_get_template_sidebars( $page_title_values, 'left', 'col-md-4 order-md-1' );
	}elseif( $sidebar_layout == 'right-sidebar' ){
		Firefront_Wp_Elements::firefront_get_template_sidebars( $page_title_values, 'right', 'col-md-4 order-md-3' );
		...
		Firefront_Wp_Elements::firefront_get_template_sidebars( $page_title_values, 'left', 'col-md-'. esc_attr( $col ) .' order-md-1' );
		Firefront_Wp_Elements::firefront_get_template_sidebars( $page_title_values, 'right', 'col-md-'. esc_attr( $col ) .' order-md-3' );
	}
endif;