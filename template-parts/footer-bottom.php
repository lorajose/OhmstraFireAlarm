...
$footer_bottom_values = Firefront_Wp_Elements::firefront_get_meta_and_option_values( $keys );
...
/*
 * Hook: firefront_top_footer_bottom.
 *
 */
do_action( 'firefront_top_footer_bottom' );
?>
...
<div class="footer-bottom-wrap">
	<div class="<?php echo esc_attr( $container_class ); ?>">
		<div class="row">
			<div class="col-12">
			<?php
				$copyright_items = Firefront_Wp_Elements::firefront_options('copyright-bar-items');
				if( !empty( $copyright_items ) ):
					...
					foreach( $copyright_items as $key => $value ){
						...
						foreach ($value as $element => $label) {
							switch ($element) {
								case "copyright-text": 									
									$copyright_html = get_option( 'firefront_options' )['copyright-text'];
										if( $copyright_html ):
									...
									case "copyright-widgets":
										$cr_sidebar_name = Firefront_Wp_Elements::firefront_options('copyright-widget');
...
<?php
/*
	Hook: firefront_after_footer_bottom.
*
*/
do_action( 'firefront_after_footer_bottom' );
